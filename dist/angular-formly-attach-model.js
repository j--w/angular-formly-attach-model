(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("angular"), require("angular-formly"));
	else if(typeof define === 'function' && define.amd)
		define(["angular", "angular-formly"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("angular"), require("angular-formly")) : factory(root["angular"], root["angular-formly"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var formly = __webpack_require__(3);
	if (ON_TEST) {
	...
	function formlyAttachModel() {
	  return {
	    require: 'ngModel',
	    link: function link(scope, el, attrs, ngModelController) {
	...
	exports['default'] = _angular2['default'].module('formlyAttachModel', [formly]).directive('formlyAttachModel', formlyAttachModel).name;

	if (ON_TEST) {
	  __webpack_require__(5)(_angular2['default'].module('formlyAttachModel'));
	}
...
/***/ function(module, exports) {
	...
	exports['default'] = function (ngModule) {
	  ...
	  describe('attach-model', function () {
	    var $compile = undefined,
	        scope = undefined,
	        el = undefined,
	        formlyConfig = undefined,
	        field = undefined,
	        template = undefined;
	    beforeEach(window.module(ngModule.name));
	    beforeEach(inject(function (_$compile_, _formlyConfig_, _$timeout_, $rootScope) {
